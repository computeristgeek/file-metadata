...
import pywikibot  # noqa: (module level import not at top of file)

from pywikibot import config  # noqa: (module level import not at top of file)
...
def get_site_and_lang(default_family='wikipedia', default_lang='en',
    ...
    if len(known_langs) == 0:
        pywikibot.output('There were no known languages found in {0}.'
                         .format(fam.name))
        default_lang = None
