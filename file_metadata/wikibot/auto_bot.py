...
# -*- coding: utf-8 -*-
"""
Script to run analysis on files and add categories to those files
automatically. This script should be run with care as it automatically
makes edits on wikimedia using your account. You are liable for any edit
made with your account.

Syntax:

    wikibot-filemeta-auto [-arguments ...]
...
def handle_bulk_pages(gen):
    ...
    for ipage, page in enumerate(gen):
        ...
        put_cats(page, cats, always=True)
