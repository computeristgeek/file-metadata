...
# suppress .../pywikipedia/externals/opencv/__init__.py:43:
# RuntimeWarning: to-Python converter for std::vector<float, std::allocator<float> > already registered; second conversion method ignored.
